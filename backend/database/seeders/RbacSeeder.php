...
return function (PDO $db): void {
    ...
    $defaultRolePermissions = [
        ...
        'job_seeker' => ['job_seekers.update', 'applications.view', 'applications.create', 'assessments.view', 'assessments.take', 'interviews.view', 'messages.view', 'messages.send', 'notifications.view', 'notifications.manage'],
        ...
        'relationship_officer' => ['relationship_officers.update', 'recruiters.view', 'jobs.view', 'jobs.create', 'jobs.update', 'jobs.close', 'applications.view', 'messages.view', 'messages.send', 'notifications.view', 'notifications.manage'],
    ];
